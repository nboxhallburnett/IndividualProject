...
\label{intro}
	...
	\section{Project Deliverable}
		...
		\begin{itemize}
			\item A system capable of easily designing and creating non-Euclidean virtual environments % expand on this sentence more

			\item A comprehensive analysis of the data gathered during the experiments undertaken using the created system % Expand on this some more
		\end{itemize}
