...
\label{intro}
	...
	\section{Project Deliverable}
		...
		\begin{itemize}
			\item A system capable of easily designing and creating non-Euclidean virtual environments % TODO: expand this more

			\item A comprehensive analysis of data gathered during the experiments undertaken using the created system % TODO: Expand this
		\end{itemize}
