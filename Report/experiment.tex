	...
	\label{exp:exp}
		...
		\label{exp:exp:ne}
			...
			\subsubsection{Immersion}
				...
				For the results gathered for the non-Euclidean scene (\autoref{exp:fig:ne_immersion}), there was a mean value of $7$ which is the same as the standard scene, however for this scene there was a higher standard deviation, at $1.342$ (4 Significant Figures).
			...
			\subsubsection{Navigation Comfort}
				...
				The lower standard deviation for this scene shows that, even though the mean value was lower, participants % TODO: Finish this sentence
