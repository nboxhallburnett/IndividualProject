...
\label{exp}
	...
	\label{exp:exp}
		...
		\label{exp:exp:standard}
			...
			\subsubsection{Immersion}
				...
				To judge a participant's sense of immersion within the scene, they were asked to rate their sense of immersion on a scale of 1 - 10, with 1 being \enquote{No Immersion} and 10 being \enquote{Fully Immersed}.
				...
				$40\%$ of the participants commented saying the 1:1 tracking of their heads in the game scene positively impacted their immersion in the scene.
			...
			\subsubsection{Navigation Comfort}
				...
				Although there is a high mean value for the results, the high standard deviation shows that the navigation comfort within the scene was not consistent between all participants.
			...
			\subsubsection{Correlation}
				...
				By mapping the results a participant gave in this scene for both metrics on a scatter graph (\autoref{exp:fig:standard_relation}), it is possible to work out whether a user's sense of comfort navigating in the scene effects their sense of immersion within it.
		...
		\label{exp:exp:ne}
			...
			\subsubsection{Immersion}
				...
				As with the standard scene, participant's immersion was rated on a scale of 1 - 10.
				...
				$40\%$ of the comments regarding factors that impacted the feeling of immersion within the scene mention the \enquote{puzzling} nature of the layout as a positive influence.
			...
			\subsubsection{Navigation Comfort}
				...
				The lower mean value in this scene indicates that navigating a non-Euclidean scene is potentially disorienting for a user, at least compared to navigation within a Euclidean virtual environment.
		...
		\label{exp:exp:comp}
			...
			This indicates that if a participant views a standard Euclidean environment prior to viewing a non-Euclidean environment, their sense of immersion has a high chance of increasing with the change.

			\begin{figure}[H]
				\includegraphics[width=1\textwidth]{Images/Compare_Immersion_Exp_1}
				\centering
				\caption{Comparison of participant's sense of immersion in the two test scenes, from Experiment 1}
			...
			The varied results from Experiment 2 give no clear indication whether transitioning from a non-Euclidean scene to a Euclidean one effects a user's sense of immersion either way.

			\begin{figure}[H]
				\includegraphics[width=1\textwidth]{Images/Compare_Immersion_Exp_2}
				\centering
				\caption{Comparison of participant's sense of immersion in the two test scenes, from Experiment 2}
	...
	\label{exp:summary}
		...
		This could be seen in a comment regarding a negative change in a participant's immersion in the standard scene: \enquote{Not any different to the other one}.
