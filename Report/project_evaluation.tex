...
\label{eval}
	...
	% So you decided to do a mix of your original proposal with that one, and you found it to be more interesting as a result
	...
	% Talk about how you could have made use of further possibilities of the system, such as one way paths, or walking into the same room, but on a different surface, etc
